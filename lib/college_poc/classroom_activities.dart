    ...
    return Scaffold(
              ...
              children: [
                const Padding(
                  padding: EdgeInsets.only(
                      bottom: 5, left: 0, right: 850, top: 50),
                  child: Text(
                ...
                const Padding(
                  padding: EdgeInsets.only(bottom: 5, right: 1250, left: 0),
                  child: Text(
                    'BIT321k',
                    style: TextStyle(
                      fontFamily: 'Montserrat-Bold',
                ...
                const Padding(
                  padding: EdgeInsets.only(bottom: 90, right: 1150, left: 0),
                  child: Text(
                    'Danny Boy Casimero',
                    style: TextStyle(
                      fontFamily: 'Montserrat-Bold',
      ...
      body: const SingleChildScrollView(
        child: Column(
          children: [
            Padding(
              padding: EdgeInsets.only(left: 1300, top: 15),
              child: AddTaskButton(),
            ),
            Padding(
              ...
              Row(
                children: [
                  GestureDetector(
                    ...
                    child: const Text(
                      'Edit ',
                      style: TextStyle(fontSize: 15, color: Colors.blue, fontFamily: 'Montserrat-Regular'),
                    ),
                  ),
